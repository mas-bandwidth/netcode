...
* Many security features including robust protection against maliciously crafted packets, packet replay attacks and your server being used in UDP packet amplification attacks.
